...
/* harmony import */ var _modules_changeModalStat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/changeModalStat */ "./src/js/modules/changeModalStat.js");
...
/***/ "./src/js/modules/changeModalStat.js":
/*!*******************************************!*\
  !*** ./src/js/modules/changeModalStat.js ***!
  \*******************************************/
...
;
/* harmony default export */ __webpack_exports__["default"] = (changeModalStat);
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.status img').src = message.loading; // document.querySelector('.status').textContent = message.loading;
...
function modals(triggerSelector, modalSelector, closeSelector) {
  ...
  function bindModal(trigger, modal, close) {
    ...
    modalEngineerClose.addEventListener('click', function () {
    ...
    modalEngineer.addEventListener('click', function (e) {
  ...
  bindModal(triggerSelector, modalSelector, closeSelector); // TimeOpenModal('.popup', 60000);
}
